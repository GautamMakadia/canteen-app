...
public class OrderService {
    ...
    public List<OrderResponse> findTodayOrderByCustomer(Long customerId) {
        return orderRepository.findTodayOrderByCustomerId(customerId).map(orderMapper::toResponse).toList();
    }
